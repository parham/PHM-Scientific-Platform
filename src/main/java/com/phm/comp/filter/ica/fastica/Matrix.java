 ...
 * compute matrices. Here two-dimensional arrays represent matrices and are
 * taken as columns of rows.
 *
...
public class Matrix {
    ...
    /**
     * Converts a matrix object into a <code>String</code> object representing
     * its content.
     *
    ...
    /**
     * Performs a matrix vector multiplication and returns the result in a new
     * vector object.
     *
    ...
    /**
     * Scales all elements of the matrix and returns the result in a new matrix
     * object.
     *
    ...
    /**
     * Transposes a matrix and returns the result in a new matrix object.
     *
     ...
     * vector. The remaining elements of the matrix contain zero.
     *
    ...
    /**
     * Returns the <code>j</code>'th column of a matrix as a new object.
     *
     * @param mat the matrix
    ...
    /**
     * Returns the <code>i</code>'th row of a matrix as a new object.
     *
     * @param mat the matrix
