function [weights, connections, errors] = growing_neural_gas_func (data)
    %% Initialize GNG system
    e_b = 0.05;
    e_n = 0.0006;
    age_max = 88;
    landa = 200;
    ...
    %neuronsWeight = randi ([10 300], [2 neuronDim]);
    neuronsWeight = [data(randi([1 length(data)]),:); data(randi([1 length(data)]),:)];
